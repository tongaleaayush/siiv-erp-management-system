...
class CustomerCreateSchema(Schema):
    ...
    customer_type = fields.String(
        ...
        validate=validate.OneOf(["BUSINESS", "INDIVIDUAL"]),
    )
    ...
    address_line_1 = fields.String(allow_none=True, validate=validate.Length(max=255))
    address_line_2 = fields.String(allow_none=True, validate=validate.Length(max=255))
    ...
    country = fields.String(load_default="India", validate=validate.Length(max=100))
    postal_code = fields.String(allow_none=True, validate=validate.Length(max=20))
    gst_number = fields.String(allow_none=True, validate=validate.Length(equal=15))
...
class CustomerResponseSchema(Schema):
    ...
    gst_number = fields.String(allow_none=True)
